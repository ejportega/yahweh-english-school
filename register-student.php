				...
				<div class="col-lg-10">
					<div id="parent" class="row justify-content-center m-0">
						<div class="panel-heading text-center">
							<h3>Student registration for Yahweh English School</h3>
						</div>
						<!-- /.panel-heading -->
						<div class="col-lg-6 p-0">
							<div class="panel-body">
								<form id="form" action="includes/libs/register-student.php" method="POST">
									<fieldset>
						...
						<div class="col-lg-6 p-0 ">
							<div class="panel-body">
								<fieldset>
									...
									<div class="form-group">
										<label>Age</label>
										<input id="age" class="form-control" type="number" name="age" min="4" max="60" placeholder="Enter your age"  required>
										<div class="invalid-feedback">Your age must be 4 above.</div>
									</div>
									<div class="form-group">
										<label>Skype</label>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button class="btn btn-primary"><a class="" href="student/exam-instruction.php">Done</a></button>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$('#form').submit(function(e) {
				...
				$.ajax({
					url: 'includes/libs/register-student.php',
					type: 'post',
					data: {
						'fname': fname,
						'lname': lname,
