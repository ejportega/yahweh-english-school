...
<div class="collapse navbar-collapse" id="navbarResponsive">
  <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Report Tasks">
      <a class="nav-link" href="my-students.php">
        <i class="fa fa-fw fa-users" aria-hidden="true"></i>
        <span class="nav-link-text">My Students</span>
      </a>
    </li>
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Availability Schedule">
      <a class="nav-link" href="availability-schedule.php">
        <i class="fas fa-fw fa-clock"></i>
        <span class="nav-link-text">Availability Schedule</span>
      </a>
    </li>
    ...
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Report Tasks">
      <a class="nav-link" href="report.php">
        ...
        <span class="nav-link-text">Report Tasks</span>
      </a>
    </li>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Select "Logout" below if you are ready to end you curret session.</p>
      </div>
